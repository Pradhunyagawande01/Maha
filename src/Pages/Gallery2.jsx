      ...
      {/* dotted background layer */}
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 gap-4 md:hidden">
            ...
            {/* stats */}
            <div className="bg-transparent text-yellow-500 font-bold flex flex-col justify-center items-center py-4">
            ...
            <div className="bg-transparent text-yellow-600 font-bold flex flex-col justify-center items-center py-4">
            ...
            <CornerBorderWrapper>
              <div className="bg-transparent h-48 sm:h-60">
                <img src="/img/img4.jpg" alt="Gallery image 6" className="w-full h-full object-cover rounded-md" />
              </div>
            </CornerBorderWrapper>
          ...
          <div className="relative w-full mx-auto hidden md:block md:pl-24 px-2">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-12 md:grid-rows-5 md:gap-4">
              ...
              <div className="md:col-span-3 md:row-span-3 md:col-start-1 md:row-start-3">
                <CornerBorderWrapper>
                  <img src="/img/Sujalda.jpg" alt="Gallery image 6" className="w-full h-full object-cover rounded-md" />
                </CornerBorderWrapper>
              </div>
              ...
              {/* stats cluster */}
              <div className="md:col-span-3 md:col-start-6 md:row-start-1 flex flex-col justify-center items-center bg-transparent text-yellow-500 font-bold py-8">
                <span className="text-7xl font-extrabold">350+</span>
                <span className="text-xl font-semibold mt-1">Hackers</span>
              </div>

              <div className="md:col-span-3 md:col-start-1 md:row-start-2 flex flex-col justify-center items-center bg-transparent text-yellow-500 font-bold py-8">
                <span className="text-7xl font-extrabold">24+</span>
                <span className="text-xl font-semibold mt-1">Hack Hours</span>
              </div>

              <div className="md:col-span-3 md:col-start-4 md:row-start-3 flex flex-col justify-center items-center bg-transparent text-yellow-500 font-bold py-8">
                <span className="text-7xl font-extrabold">25+</span>
                <span className="text-xl font-semibold mt-1">Mentors</span>
              </div>

              <div className="md:col-span-2 md:row-span-3 md:col-start-9 md:row-start-3 flex flex-col justify-center items-center bg-transparent text-yellow-600 font-bold py-8">
                <span className="text-7xl font-extrabold">50+</span>
                <span className="text-xl font-semibold mt-1">Partners</span>
              </div>

              <div className="md:col-span-2 md:row-span-5 md:col-start-5 md:row-start-5 flex flex-col justify-center items-center bg-transparent text-yellow-600 font-bold py-8">
